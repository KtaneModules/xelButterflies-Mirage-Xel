...
public class Butterflies : MonoBehaviour {
    ...
    string[] commonNames = new string[] { "Eastern Tiger Swallowtail", "Ornythion Swallowtail", "Spicebush Swallowtail",  "Pipevine Swallowtail", "Polydamas Swallowtail", "Zebra Swallowtail", "Chiricahua White", "Checkered White", "Orange-Barred Sulphur", "Labrador Sulphur", "Sleepy Orange", "Desert Orangetip", "White M Hairstreak", "Great Purple Hairstreak", "Colorado Hairstreak", "Common Buckeye", "Milbert's Tortoiseshell", "Eastern Comma", "Lustrous Copper", "Blue Copper", "American Copper", "Grizzled Skipper", "Eastern Tailed-Blue", "Theona Checkerspot", "Little Metalmark", "Zebra Heliconian", "Tiger Mimic Queen", "Regal Fritilary", "Diana Fritilary", "Crimson Patch", "White Peacock", "Banded Peackock", "Malachite", "Rusty-Tipped Page", "Painted Lady", "Mexican Bluewing", "Viceroy", "Monarch", "Red-Spotted Purple", "Ruddy Daggerling", "Litte Wood Satyr", "Guava Skiper"};
    string[] scientificNames = new string[] {"Papilo glaucus", "Papilo ornythion", "Papilo troilus", "Battus philenor", "Battus polydamus", "Eurytides marcellus", "Neophasia terlootii", "Pontia protodice", "Pobeis philea", "Colias nastes", "Eurema nicippe", "Anthocharis cehura", "Parrhasius m-alubm", "Atlides halesus", "Hypaurotis crysalus", "Junonia coenia", "Nymphalis milberti", "Polygonia comma", "Lycenia cupriea", "Lycenia heteronea", "Lycena phlaeas", "Pyrgus centaureae", "Everes comyntas",  "Chlosyne theona", "Calephelis virginis", "Heliconius charithonia", "Lycorea halia", "Speryeia idalia", "Speyeria diana", "Chlosyne janais", "Anartia jatrophae", "Anartia fatima", "Siproeta stelenes", "Siproeta epaphus", "Vanessa cardui", "Myscelia ethusa", "Limenitis archippus", "Danaus plexipus", "Limenitis arthemis", "Marpesia petreus", "Megisto cymela", "Phocides palemon"};
    string[] names;
    ...
    void Start () {
        ...
        Debug.LogFormat("[Butterflies #{0}] The butterflies in the order they appear on the module are {1}.", moduleId, namesUsed.Join(", "));
        namesUsed.Sort();
        Debug.LogFormat("[Butterflies #{0}] The butterflies in the order they should be pressed are {1}.", moduleId, namesUsed.Join(", "));
	...
	void pressButterfly (KMSelectable butterfly) {
		if (!solved)
        {
            ...
            Debug.LogFormat("[Butterflies #{0}] You pressed {1}.", moduleId, names[butterflyIndices[Array.IndexOf(butterflies, butterfly)]]);
            if (butterflyIndices[Array.IndexOf(butterflies, butterfly)] != butterflyIndicesOrdered[stage])
            {
                module.HandleStrike();
                Debug.LogFormat("[Butterflies #{0}] That was incorrect. Strike!", moduleId);
            ...
            {
                module.HandlePass();
                Debug.LogFormat("[Butterflies #{0}] That was correct. Module solved.", moduleId);
